...
var NoteDrawPlugin = class extends import_obsidian.Plugin {
  ...
  installWebviewObserver() {
    if (typeof MutationObserver === "undefined" || !import_obsidian.activeDocument?.body) {
      return;
    }
    ...
    this.webviewMutationObserver.observe(import_obsidian.activeDocument.body, {
      subtree: true,
      childList: true,
      attributes: true,
  ...
  syncWebviewControllers() {
    const surfaces = findWebviewSurfaces(import_obsidian.activeDocument);
  ...
  installSurfaceButton(controller) {
    ...
    const button = import_obsidian.activeDocument.createElement(inline ? "button" : "div");
    if (inline) {
...
`);
  ...
  async injectExportImageCanvasLayer(file, container, drawingData = null) {
    ...
    const layer = import_obsidian.activeDocument.createElement("div");
  ...
  async drawExportImageStrokeOn(layer, stroke, width, height) {
    ...
    const canvas = import_obsidian.activeDocument.createElement("canvas");
...
var PreviewDrawingController = class {
  ...
  async mount() {
    ...
    this.floatingControlsHost = this.floatingControlsInBody ? import_obsidian.activeDocument.body : this.previewEl;
    ...
    import_obsidian.activeDocument.addEventListener("selectionchange", this.onDocumentSelectionChange);
  ...
  destroy() {
    ...
    import_obsidian.activeDocument.removeEventListener("selectionchange", this.onDocumentSelectionChange);
  ...
  startFormatToolbarDrag(event) {
    ...
    import_obsidian.activeDocument.addEventListener("pointermove", this.onFormatToolbarDragMove, true);
    import_obsidian.activeDocument.addEventListener("pointerup", this.onFormatToolbarDragEnd, true);
    import_obsidian.activeDocument.addEventListener("pointercancel", this.onFormatToolbarDragEnd, true);
  }
  ...
  stopFormatToolbarDrag() {
    ...
    import_obsidian.activeDocument.removeEventListener("pointermove", this.onFormatToolbarDragMove, true);
    import_obsidian.activeDocument.removeEventListener("pointerup", this.onFormatToolbarDragEnd, true);
    import_obsidian.activeDocument.removeEventListener("pointercancel", this.onFormatToolbarDragEnd, true);
  }
  restoreTextRange() {
  ...
  applyTextInlineFormat(tagName, styles = {}) {
    ...
    const wrapper = import_obsidian.activeDocument.createElement(tagName);
  ...
  applyTextBlockFormat(kind) {
    ...
    if (kind === "code") {
      const pre = import_obsidian.activeDocument.createElement("pre");
      const code = import_obsidian.activeDocument.createElement("code");
  ...
  insertTextBreak() {
    ...
    range.deleteContents();
    const br = import_obsidian.activeDocument.createElement("br");
    range.insertNode(br);
  ...
  clearTextFormat() {
    ...
    const textNode = import_obsidian.activeDocument.createTextNode(plainText);
    range.deleteContents();
    range.insertNode(textNode);
    const nextRange = import_obsidian.activeDocument.createRange();
  ...
  startTextEdit(element, clientPoint = null) {
    ...
    const onBlur = () => {
      window.setTimeout(() => {
        const active = import_obsidian.activeDocument.activeElement;
...
function detectNoteDrawLanguage(app) {
  ...
  const candidates = [
    ...
    import_obsidian.activeDocument.documentElement.lang,
    navigatorLanguage,
    ...navigatorLanguages,
    app?.appId
  ];
...
function createNoteDrawControlElement(parent, cls) {
  ...
  if (parent === import_obsidian.activeDocument.body) {
...
function rangeFromClientPoint(element, clientPoint) {
  ...
  try {
    ...
    if (typeof import_obsidian.activeDocument.caretPositionFromPoint === "function") {
      ...
      const legacyCaretRangeFromPoint = import_obsidian.activeDocument[["caret", "Range", "From", "Point"].join("")];
      if (typeof legacyCaretRangeFromPoint === "function") {
        range = legacyCaretRangeFromPoint.call(import_obsidian.activeDocument, clientPoint.x, clientPoint.y);
      }
    }
  } finally {
    if (overlay) {
...
function cleanupAllDrawingHeaderButtons() {
  import_obsidian.activeDocument.querySelectorAll(".notedraw-header-button, .notedraw-webview-button").forEach((button) => button.remove());
  import_obsidian.activeDocument.body?.querySelectorAll?.(".notedraw-body-control, .notedraw-file-input").forEach((element) => element.remove());
}
...
function sanitizeHTMLToDomSafe(content) {
  ...
  const fragment = import_obsidian.activeDocument.createDocumentFragment();
  Array.from(parsed.body.childNodes).forEach((node) => {
    fragment.appendChild(import_obsidian.activeDocument.importNode(node, true));
  });
