...
`);
    ...
    var PreviewDrawingController = class {
      ...
      drawStructuredStrokeOn(ctx, stroke, alpha = 1) {
        ...
        if (stroke.kind === TOOL_TEXT) {
          ...
          const fontFamily = stroke.code ? "ui-monospace, SFMono-Regular, Consolas, monospace" : "system-ui, -apple-system, Segoe UI, sans-serif";
    ...
    function cleanupDrawingUi(preview) {
      preview.querySelectorAll(".notedraw-button, .notedraw-fallback-button, .notedraw-toolbar, .notedraw-palette-panel, .notedraw-canvas").forEach((element) => element.remove());
    ...
    function normalizeStroke(stroke) {
      ...
      return {
        ...kind ? {
          ...
          code: kind === TOOL_TEXT ? Boolean(stroke?.code) : void 0,
          file: kind === TOOL_TEXT ? Boolean(stroke?.file) : void 0
        } : {},
